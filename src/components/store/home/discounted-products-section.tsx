...
export function DiscountedProductsSection() {
			...
			<section className="py-20">
				<div className="container mx-auto px-4">
					<div className="flex gap-6 overflow-hidden">
						{[1, 2, 3, 4].map((i) => (
							<div key={i} className="w-[280px] flex-shrink-0 aspect-[3/4] bg-muted animate-pulse rounded-2xl" />
						))}
					</div>
				</div>
			</section>
	...
	return (
		<section className="py-20 bg-gradient-to-b from-destructive/5 to-transparent">
			<div className="container mx-auto px-4">
				{/* Section header */}
				<div className="flex items-end justify-between mb-10">
					<div>
						<motion.span
							...
							viewport={{ once: true }}
							className="text-xs font-bold uppercase tracking-[0.2em] text-destructive mb-2 block"
						>
							Fırsatlar
						</motion.span>
						<motion.h2
					...
					<div className="flex items-center gap-2">
						...
						<Button variant="ghost" asChild className="ml-2 hidden md:flex">
							<Link href="/urunler?hasDiscount=true">
								Tümünü Gör →
							</Link>
						</Button>
					</div>
