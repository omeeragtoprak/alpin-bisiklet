...
const navigation = [
  { name: "Ana Sayfa", href: "/" },
  {
    ...
    children: [
      ...
      { name: "Şehir Bisikleti", href: "/urunler?kategori=sehir-bisikleti" },
      { name: "Çocuk Bisikleti", href: "/urunler?kategori=cocuk-bisikleti" },
      { name: "Elektrikli Bisiklet", href: "/urunler?kategori=elektrikli-bisiklet" },
    ],
  },
  {
    name: "Aksesuarlar",
