...
const navigation = [
  ...
  {
    name: "Bisikletler",
    href: "/urunler?kategori=bisikletler",
    children: [
      { name: "Dağ Bisikletleri", href: "/urunler?kategori=dag-bisikletleri" },
      { name: "Yol Bisikletleri", href: "/urunler?kategori=yol-bisikletleri" },
      { name: "Şehir Bisikletleri", href: "/urunler?kategori=sehir-bisikletleri" },
      { name: "Çocuk Bisikletleri", href: "/urunler?kategori=cocuk-bisikletleri" },
    ],
  },
  {
    name: "Aksesuarlar",
    href: "/urunler?kategori=aksesuarlar",
    children: [
      { name: "Kasklar", href: "/urunler?kategori=kasklar" },
      { name: "Giysiler", href: "/urunler?kategori=giysiler" },
      { name: "Işıklar", href: "/urunler?kategori=isiklar" },
      { name: "Çantalar", href: "/urunler?kategori=cantalar" },
    ],
  },
