...
function FieldContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("group/field-content flex flex-col flex-1 gap-0.5 leading-snug", className)}
      {...props}
    />
  );
}
