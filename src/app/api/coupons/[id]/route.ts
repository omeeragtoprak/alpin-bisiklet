...
export async function PUT(
  ...
  try {
    ...
    // Junction tabloları önce sil, sonra yeniden oluştur
    await prisma.$transaction([
      prisma.couponCategory.deleteMany({ where: { couponId: numId } }),
      prisma.couponProduct.deleteMany({ where: { couponId: numId } }),
    ]);
